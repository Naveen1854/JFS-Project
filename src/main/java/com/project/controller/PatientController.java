...
public class PatientController {
    ...
    public ResponseEntity<SuccessResponse<PatientDto>> savePatient(@RequestBody PatientDto patientDto) {
        ...
        SuccessResponse<PatientDto> response = new SuccessResponse<>("Patient saved successfully",
                HttpStatus.CREATED.value(), savedPatient);
    ...
    public ResponseEntity<SuccessResponse<List<PatientDto>>> getAllPatients() {
        ...
        SuccessResponse<List<PatientDto>> response = new SuccessResponse<>("Patients fetched successfully",
    ...
    public ResponseEntity<SuccessResponse<PatientDto>> getPatientById(@PathVariable Long patientId) {
        PatientDto dbPatient = patientService.getPatientById(patientId);
        SuccessResponse<PatientDto> response = new SuccessResponse<>("Patient fetched successfully",
                HttpStatus.OK.value(), dbPatient);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<SuccessResponse<PatientDto>> updatePatientById(@PathVariable Long patientId,
                                                                         @RequestBody PatientDto newPatientDto) {
        PatientDto updated = patientService.updatePatientById(patientId, newPatientDto);
        SuccessResponse<PatientDto> response = new SuccessResponse<>("Patient updated successfully",
    ...
    public ResponseEntity<SuccessResponse<PatientDto>> deletePatientById(@PathVariable Long patientId) {
        ...
        SuccessResponse<PatientDto> response = new SuccessResponse<>("Patient deleted successfully",
